...
export default function App() {
  ...
  const chaptersData = [
    ...
    },
    {
      ...
      story: 'Spinning 360 degrees through a kaleidoscopic vortex from the top-right, 3D particle compositing & title design come alive!',
